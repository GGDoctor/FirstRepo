...
#define UE_PROJECT_NAME TopDownShmup
#define UE_TARGET_NAME TopDownShmupEditor
#define UE_MODULE_NAME "TopDownShmup"
...
#define TOPDOWNSHMUP_API DLLEXPORT
